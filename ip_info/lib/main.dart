// ignore_for_file: prefer_const_constructors_in_immutables, avoid_print, unnecessary_string_interpolations
...
print(ipinfo);
         ...
         Padding(
           ...
           child: Column(children: [
            const Text("Information about the ip",style: TextStyle(color: Colors.white,fontSize: 15.0),),
           Text(ipinp.text,style: const TextStyle(color: Colors.white,fontSize: 22.0),)
