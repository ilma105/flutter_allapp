// ignore_for_file: unused_element, prefer_is_empty, camel_case_types
  ...
  Widget build(BuildContext context) {
    return     SliverToBoxAdapter(
      ...
      child: Consumer<Wish_prov>(
        builder:(context,wishprov,child)=>wishprov.items.length ==0? const Center(child: Text("no products in cart")): ListView.builder(
