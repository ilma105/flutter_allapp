// ignore_for_file: must_be_immutable, unused_element, prefer_final_fields, non_constant_identifier_names, prefer_is_empty, camel_case_types
    ...
    Text("Checkout",style: TextStyle(fontSize: 14.sp,fontWeight: FontWeight.w700,color: MyColors.bc),),
         ...
         Padding(
           ...
           child: Consumer<Cart_prov>(
             builder:(context,card_prov,child)=> Row(
              ...
              children: [
                Text("Toatal(${card_prov.totalitem}) Items",style: const TextStyle(color: MyColors.bc),),
       ...
       Padding(
           ...
           child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("Shipping Fee",style: TextStyle(color: MyColors.bc),),
       ...
       const Divider(),
        Padding(
           ...
           child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("Sub Total",style: TextStyle(color: MyColors.bc),),
...
class _ProductItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return     SliverToBoxAdapter(
      ...
      child: Consumer<Cart_prov>(
        builder:(context,cartprov,child)=>cartprov.items.length ==0? const Center(child: Text("no products in cart")): ListView.builder(
