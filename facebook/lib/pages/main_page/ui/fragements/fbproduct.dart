// ignore_for_file: must_be_immutable, avoid_print, camel_case_types, avoid_unnecessary_containers, unnecessary_string_interpolations, prefer_typing_uninitialized_variables, unused_element
...
class FbProductFrag extends StatelessWidget {
   FbProductFrag({super.key});
...
List titles=["Ilma","Saima Hossain","Sazia Rahman","Farhan Hossain","Shupta Das","Lamia"];
            return homeFragProv.iscatloading?const Center(child: CircularProgressIndicator(color: MyColors.bc,),): ListView.builder(
...
return Padding(
  ...
  padding: const EdgeInsets.symmetric(vertical:12.0,horizontal: 8.0),
      ...
      decoration: BoxDecoration(color:isselected? MyColors.bc: const Color.fromARGB(255, 199, 190, 190),
  borderRadius: BorderRadius.circular(12.0),
  image: DecorationImage(
                              image: AssetImage(bg),
                              fit: BoxFit.cover,
