// ignore_for_file: camel_case_types, must_be_immutable, unused_element, non_constant_identifier_names
      ...
      child:Text(title,style: TextStyle(
        ...
        child: Consumer<Cart_prov>(
          builder:(context,cart_prov,child)=> Row(
            ...
            InkWell(
              ...
              child: const CircleButton(icon:  Icon(Icons.remove,color: MyColors.hint,))), 
        ...
        Text(cart_prov.countprod(product).toString(),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.sp),),
           ...
           InkWell(
            ...
            child: const CircleButton(icon: Icon(Icons.add,color: MyColors.bc,)))
